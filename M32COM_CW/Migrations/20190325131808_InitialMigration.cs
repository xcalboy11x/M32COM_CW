        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Charger = table.Column<string>(nullable: true),
                    Height = table.Column<decimal>(nullable: false),
                    HullLength = table.Column<decimal>(nullable: false),
                    Motor = table.Column<string>(nullable: true),
                    Name = table.Column<string>(nullable: true),
                    OnBoardElectronics = table.Column<string>(nullable: true),
                    TeamId = table.Column<int>(nullable: false),
                    TotalLength = table.Column<decimal>(nullable: false),
                    Transmitter = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Boat", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Boat_Team_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Team",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(maxLength: 30, nullable: false),
                    PromoImage = table.Column<byte[]>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Entry_Event_EventID",
                        column: x => x.EventID,
                        principalTable: "Event",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Entry_Team_TeamID",
                        column: x => x.TeamID,
                        principalTable: "Team",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Entry_EventID",
                table: "Entry",
                column: "EventID");

            migrationBuilder.CreateIndex(
                name: "IX_Entry_TeamID",
                table: "Entry",
                column: "TeamID");
